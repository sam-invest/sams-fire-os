Sam's FIRE OS Web v5.3 — Supabase Cloud Sync
...
최초 동기화:
1) 기존 v5.0 실제 자료가 들어 있는 PC 브라우저에서 먼저 v5.3 사이트를 엽니다.
...
[v5.3 시세 서버 설정]
Supabase Dashboard > Edge Functions > Deploy a new function > Via Editor에서 함수 이름을 quote로 만들고 supabase/functions/quote/index.ts 내용을 붙여넣은 뒤 Deploy function을 누르세요. 기본 JWT 검증은 유지합니다.
